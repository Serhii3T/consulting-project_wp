...
const projectPaths = {
    ...
    projectScssPath:   path.resolve( __dirname, 'assets/src/sass' ),
...
const projectFiles = {
    ...
    projectCss: {
        ...
        // styling files which are being imported in "assets/src/js/index.js" and "assets/src/js/backend.js".
