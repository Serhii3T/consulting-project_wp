...
get_header();
    $marker = 'http://consulting.local/wp-content/uploads/2022/02/beetroot-sm.png';
    $imgInfoWindow = 'http://consulting.local/wp-content/uploads/2022/02/beetroot.jpg';
?>
    <main class="c-main">
        <!--    page contact    -->
        <div class="c-page-contact">
            <?php get_template_part('./template-parts/contact-blocks/banner') ?>
            <?php get_template_part('./template-parts/contact-blocks/map') ?>
            <?php get_template_part('./template-parts/contact-blocks/form') ?>
        </div>

    </main>
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDiEmsKAKsKemDEdKCyGaW-Klp3XYlUQN8&amp;callback=initMap&amp;libraries=&amp;v=weekly"></script>
    <script>
        window.initMap = function() {
            ...
            if (mapBlock != null) {
                ...
                const contentString =
                    ...
                    '<img src="<?php echo $imgInfoWindow ?>" alt="beetroot">' +
                    "</div>" +
