...
/***/ "./assets/js/functions/btnLoadMore.js":
/*!********************************************!*\
  !*** ./assets/js/functions/btnLoadMore.js ***!
  \********************************************/
...
var btnLoadMore = function btnLoadMore() {
  //  Tab show hidden
  var btnLoad = document.querySelector('.c-chapter__btn');

  if (btnLoad != null) {
    btnLoad.addEventListener('click', function () {
      var blocks = document.querySelectorAll(".c-chapter__block");
...
/* harmony default export */ __webpack_exports__["default"] = (btnLoadMore);

/***/ }),

/***/ "./assets/js/functions/burgerBlock.js":
/*!********************************************!*\
  !*** ./assets/js/functions/burgerBlock.js ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burgerBlock = function burgerBlock() {
  // burger menu
...
/* harmony default export */ __webpack_exports__["default"] = (burgerBlock);

/***/ }),

/***/ "./assets/js/functions/formBlock.js":
/*!******************************************!*\
  !*** ./assets/js/functions/formBlock.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var formBlock = function formBlock() {
  //  contact form submit
  var formBlock = document.querySelector(".c-form__contact");
  var subscribleBlock = document.querySelector(".c-newsletter__form");

  if (formBlock != null) {
    formBlock.addEventListener('submit', function (e) {
      e.preventDefault();
      formBlock.classList.add('hidden');
      var thankBlock = document.querySelector('.thank-message');
...
/***/ "./assets/js/functions/swiperBlock.js":
/*!********************************************!*\
  !*** ./assets/js/functions/swiperBlock.js ***!
  \********************************************/
/*! exports provided: default */
...
var swiperBlock = function swiperBlock() {
  var sliderBlock = document.querySelector(".our-mission-swiper");

  if (sliderBlock != null) {
    var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".our-mission-swiper", {
      slidesPerView: 3,
      spaceBetween: 30,
      init: false,
      grabCursor: true,
...
/***/ "./assets/js/functions/tabClick.js":
/*!*****************************************!*\
  !*** ./assets/js/functions/tabClick.js ***!
  \*****************************************/
/*! exports provided: default */
...
var tabClick = function tabClick() {
  // tab click
  var navItemWork = document.querySelectorAll(".c-work__item");
  ...
  if (navItemWork != null) {
    navItemWork.forEach(function (element) {
      element.addEventListener('click', function () {
        ...
        var classBlock = this.getAttribute('data-cat');
        var blocks = document.querySelectorAll(".c-chapter__block");
        blocks.forEach(function (item) {
          item.classList.remove('active');
        });
        var blocksActive = document.querySelectorAll("." + classBlock);
  ...
  var itemIcon = document.querySelectorAll(".c-comment__circle");
  ...
  if (itemIcon != null) {
    itemIcon.forEach(function (element) {
      element.addEventListener('click', function () {
        ...
        this.classList.add('active');
        var classBlock = this.getAttribute('data-id');
        var blocks = document.querySelectorAll(".c-comment__item");
        blocks.forEach(function (item) {
          item.classList.remove('active');
        });
        var blocksActive = document.querySelectorAll(".data-id-" + classBlock);
        blocksActive.forEach(function (item) {
          item.classList.add('active');
        });
      });
...
/* harmony default export */ __webpack_exports__["default"] = (tabClick);
...
/* harmony import */ var _functions_btnLoadMore__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./functions/btnLoadMore */ "./assets/js/functions/btnLoadMore.js");
/* harmony import */ var _functions_swiperBlock__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functions/swiperBlock */ "./assets/js/functions/swiperBlock.js");
/* harmony import */ var _functions_burgerBlock__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functions/burgerBlock */ "./assets/js/functions/burgerBlock.js");
/* harmony import */ var _functions_formBlock__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./functions/formBlock */ "./assets/js/functions/formBlock.js");
/* harmony import */ var _functions_tabClick__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./functions/tabClick */ "./assets/js/functions/tabClick.js");
...
document.addEventListener("DOMContentLoaded", function (event) {
  Object(_functions_btnLoadMore__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_functions_swiperBlock__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_functions_burgerBlock__WEBPACK_IMPORTED_MODULE_3__["default"])();
  Object(_functions_formBlock__WEBPACK_IMPORTED_MODULE_4__["default"])();
  Object(_functions_tabClick__WEBPACK_IMPORTED_MODULE_5__["default"])();
});
...
module.exports = __webpack_require__(/*! ./assets/scss/index.scss */"./assets/scss/index.scss");
